...
describe('HelloWorld.vue', () => { /* Creates Test Suit -> Bundles Tests */
    // Test 1: Component renders without errors
    it('renders without errors', () => { /* Creates a single Tests */
        const wrapper = mount(HelloWorld, { /* Mounts DOM */
            props: {msg: 'Hello Vitest'},
        })
        expect(wrapper.exists()).toBe(true) /* Expected value */
    })
